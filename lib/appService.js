...
// async function getUserProfile(baseURL, realm, token){
// try {
//         const response = await fetch(`${baseURL}/admin/realms/${realm}/users/profile`, {
//             method: 'GET',
//             headers: {
//                 "Content-Type": "application/json",
//                 "Authorization": `Bearer ${token}`,
...
// async function getRealmConfig(baseURL, realm, token){
